...
/// </summary>
public class OnlineMgr : MonoBehaviourPunCallbacks
{
	...
	private async void Start()
	{
		...
		await UniTask.WaitUntil(() => !string.IsNullOrEmpty(UserAuthMgr.Instance?.UserId));
	...
	{
		// UserAuthMgr から取得（Steam or Firebase）
		string userId = UserAuthMgr.Instance?.UserId;
		bool isFirstLogin = UserAuthMgr.Instance?.IsFirstLogin ?? false;
