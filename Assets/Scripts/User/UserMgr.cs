...
public class UserMgr : MonoBehaviour
{
    ...
    [SerializeField]
    private User[] m_Users = new User[(int)Side.eSide_Max];
    ...
    private async void Start()
    {
        ...
        User playerUser    =   GetSetPlayerUser;
        User enemyUser     =   GetSetEnemyUser;
    ...
    // ユーザーIDからユーザーを取得
    public User GetUserFromUserID(int _userID)
    {
